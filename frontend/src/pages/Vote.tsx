...
const TaskCard = ({ title, description, options, status }: Omit<BallotTask, 'id' | 'startTime' | 'duration'>) => {
  const renderActions = () => {
  ...
  return (
    <div className="bg-white mb-4 shadow-md p-4 rounded-lg">
      ...
      <div className={"text-sm text-left font-medium mb-4 text-gray-700 cursor-pointer"}>
        {description}
      </div>
  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Ballots</h1>
      </div>
